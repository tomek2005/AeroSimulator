...
// Klasa skupiająca systemy pokładowe, stany (State Pattern) oraz parametry lotu.
// Agreguje komponenty i deleguje logikę lotu do aktualnego stanu.
public class Aircraft
{
    ...
    public void Update(double deltaT)
    {
        ...
        else
        {
            ...
            {
                FlightData.VerticalSpeed = -1500.0;
                FlightData.PitchAngleDeg = -10.0;
            }
        }
        ...
        if (FlightData.FuelLevelKg > 0)
        {
            ...
            double baseBurn = (Config.Aircraft.FuelBurnKgPerH / 3600.0) * throttleBurnMultiplier * engineEfficiency *
                              deltaT;
            ...
            FlightData.FuelFlowKgPerH = Config.Aircraft.FuelBurnKgPerH * throttleBurnMultiplier * engineEfficiency +
                                        FuelSystem.CurrentLeakRate;
        }
        else
        {
    ...
    // ZARZĄDZANIE SYSTEMAMI I USZKODZENIAMI
